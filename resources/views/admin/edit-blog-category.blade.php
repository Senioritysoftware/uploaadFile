                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                ...
                                                <input id="blog_category_name" name="blog_category_name" type="text" class="form-control" value="{{ $edit['category']->blog_category_name }}" data-bvalidator="required"></div>                          <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" @if($edit['category']->blog_category_status == 1) selected="selected" @endif>Active</option>
                                                <option value="0" @if($edit['category']->blog_category_status == 0) selected="selected" @endif>InActive</option>
                                                </select>
                                            </div> 
