                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <a href="{{ url('/admin/add-contact') }}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add Contact</a>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    @foreach($contactData['view'] as $contact)
                                        <tr>
                                            ...
                                            @else
                                            <a href="contact/{{ $contact->cid }}" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure you want to delete?');"><i class="fa fa-trash"></i>&nbsp;Delete</a>@endif</td></tr>@php $no++; @endphp
                                   @endforeach     
                                   </tbody>
                                </table>
                            </div>
