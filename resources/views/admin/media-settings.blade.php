                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                      <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="0" @if($setting['setting']->site_s3_storage == 0) selected @endif>My Server</option>
                                                <option value="1" @if($setting['setting']->site_s3_storage == 1) selected @endif>Amazon S3 Storage</option>
                                                </select>
                                            </div>   
                                      </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input id="aws_bucket" name="aws_bucket" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->aws_bucket }}"> <small>Example : yourbucketname</small></div></div>
                                </div>
                             </div>
                            </div>
