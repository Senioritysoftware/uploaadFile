                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    @foreach($slideData['slide'] as $slide)
                                        <tr>
                                            <td>{{ $no }}</td>
                                            <td>@if($slide->slide_image != '') <img src="{{ url('/') }}/public/storage/slideshow/{{ $slide->slide_image }}" alt="{{ $slide->slide_image }}" class="image-size" />@else <img src="{{ url('/') }}/public/img/no-image.jpg" alt="{{ $slide->slide_image }}" class="image-size"/>@endif</td>
