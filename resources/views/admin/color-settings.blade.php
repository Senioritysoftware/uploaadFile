                    ...
                    <div class="card">
                           ...
                           <div class="card-body">
                                    ...
                                    <div class="card-body">
                                       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="site_copyright_color" name="site_copyright_color" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->site_copyright_color }}" data-bvalidator="required"> <small>(example color code : #666000 )</small>
                                            </div> 
                                     </div>
                                </div>
                              </div>
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <input type="hidden" name="site_section_color" value="{{ $setting['setting']->site_section_color }}">
                                       <div class="form-group">
