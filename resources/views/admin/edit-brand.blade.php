                                    ...
                                    <div class="card-body">
                                       <div class="form-group">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <input type="file" id="brand_image" name="brand_image" class="form-control-file"  data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg">@if($edit['brand']->brand_image != '') <img  src="{{ url('/') }}/public/storage/brands/{{ $edit['brand']->brand_image }}" alt="{{ $edit['brand']->brand_image }}" class="image-size" />@else <img src="{{ url('/') }}/public/img/no-image.jpg" alt="{{ $edit['brand']->brand_image }}"  class="image-size"/>  @endif
                                            </div>                                  
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" @if($edit['brand']->brand_status == 1) selected @endif>Active</option>
                                                <option value="0" @if($edit['brand']->brand_status == 0) selected @endif>InActive</option>
                                                </select>
                                            </div>   
