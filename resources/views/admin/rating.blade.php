                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    @foreach($itemData['item'] as $rating)
                                        <tr>
                                            ...
                                            @else
                                            <a href="{{ URL::to('/admin/rating') }}/{{ $rating->rate_id }}" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure you want to delete?');"><i class="fa fa-close"></i>&nbsp; Delete</a>@endif</td>
                                        </tr>
                                        @php $no++; @endphp
                                   @endforeach     
                                    </tbody>
