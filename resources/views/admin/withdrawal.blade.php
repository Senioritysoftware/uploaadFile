                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    @foreach($itemData['item'] as $withdraw)
                                        <tr>
                                            ...
                                            <a href="{{ URL::to('/admin/withdrawal') }}/{{ $withdraw->wid }}/{{ $withdraw->user_id }}" class="btn btn-success btn-sm" onClick="return confirm('Are you sure you want to complete withdrawal request?');"><i class="fa fa-money"></i>&nbsp; Complete Withdrawal?</a>
                                            @else
