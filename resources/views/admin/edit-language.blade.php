                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" @if($edit['view']->language_default == 1) selected @endif>Yes</option>
                                                <option value="0" @if($edit['view']->language_default == 0) selected @endif>No</option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" @if($edit['view']->language_status == 1) selected @endif>Active</option>
                                                <option value="0" @if($edit['view']->language_status == 0) selected @endif>InActive</option>
                                                </select>
