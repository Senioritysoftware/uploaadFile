                           ...
                           <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    ...
                                    <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" @if($setting['setting']->site_home_top_banner == 1) selected @endif>ON</option>
                                                <option value="0" @if($setting['setting']->site_home_top_banner == 0) selected @endif>OFF</option>
                                         </select>
                                      </div>
                                      <div class="form-group">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                      <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" @if($setting['setting']->site_home_bottom_banner == 1) selected @endif>ON</option>
                                                <option value="0" @if($setting['setting']->site_home_bottom_banner == 0) selected @endif>OFF</option>
                                         </select>
                                      </div>
                                      <div class="form-group">
