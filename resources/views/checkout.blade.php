              ...
              <div class="form-row mt-4 mb-4">
               ...
               <div class="form-row mt-2 mb-2">
                           ...
                           @php $no = 1; @endphp
                                ...
                                <div class="custom-control custom-radio" @if($payment == 'paystack') @if($allsettings->site_currency_code != 'NGN') style="display:none;" @endif @endif>
                                    ...
                                    <label class="custom-control-label" for="opt1-{{ $payment }}" @if($payment == 'paystack') @if($allsettings->site_currency_code != 'NGN') style="display:none;" @endif @endif>{{ $payment }} @if($payment == 'wallet') ({{ $allsettings->site_currency_symbol }}{{ Auth::user()->earnings }}) @endif</label>
                                </div>
                                @php $no++; @endphp
                                @endforeach
                                </div>
