             ...
             {{ csrf_field() }}
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <textarea name="product_short_desc" id="product_short_desc" rows="12" class="form-control noscroll_textarea" data-bvalidator="required,maxlen[160]">{{ $edit['product']->product_short_desc }}</textarea>
                    </div>
                    <div class="col-sm-6">
