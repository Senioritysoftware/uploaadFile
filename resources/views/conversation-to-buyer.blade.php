         	    ...
         	    <div class="container emp-profile">
                  <div class="row">
                    <div class="col-md-3 white-bg">
                        ...
                        <a href="{{ url('/my-orders') }}" class="btn btn-danger btn-sm">&lt; {{ Helper::translation(2088,$translate) }}</a>
		...
		<div class="comment-wrap">
				...
				<div class="comment-block">
                        ...
                        @csrf
                                ...
                                <input type="hidden" name="conver_url" value="{{ url('/conversation-to-vendor') }}">
		...
		<div class="comment-wrap li-item">
				<div class="photo">
                       @php 
                        ...
                        @endphp 
						<div class="avatar" style="background-image: url('{{ url('/') }}/{{ $paths }}')"></div>
				</div>
				<div class="comment-block">
