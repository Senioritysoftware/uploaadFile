...
<html lang="en">
<head>
<title><?php if(Auth::user()->user_type == 'vendor'): ?><?php echo e(__('Edit Coupon')); ?><?php else: ?><?php echo e(__('404 Page Not Found!')); ?><?php endif; ?>  - <?php echo e($allsettings->site_title); ?></title>
...
<?php if(Auth::user()->user_type == 'vendor'): ?>
    <section class="headerbg" style="background-image: url('<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($allsettings->site_header_background); ?>');">
      <div class="container text-left">
        <h2 class="mb-0"><?php echo e(__('Edit Coupon')); ?></h2>
        <p class="mb-0"><a href="<?php echo e(URL::to('/')); ?>">Home</a> <span class="split">&gt;</span> <span><?php echo e(__('Edit Coupon')); ?></span></p>
      </div>
    </section>
    <main role="main">
        ...
        <div class="col-md-12">
             ...
             <?php echo e(csrf_field()); ?>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="name">Coupon Code <span class="required">*</span></label>
                    ...
                    <div class="col-sm-6">
                        <label for="name">Value <span class="required">*</span></label>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                         <label for="site_keywords">Start Date <span class="required">*</span></label>
                    ...
                    <div class="col-sm-6">
                        <label for="site_desc">End Date <span class="required">*</span></label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <select name="coupon_status" class="form-control" data-bvalidator="required">
                         <option value=""></option>
                         <option value="1" <?php if($edit['value']->coupon_status == 1): ?> selected <?php endif; ?>>Active</option>
                         <option value="0" <?php if($edit['value']->coupon_status == 0): ?> selected <?php endif; ?>>InActive</option>
                         </select>
                    </div>
                    <div class="col-sm-6">
...
<?php /**PATH D:\xampp\htdocs\zigkart\resources\views/edit-coupon.blade.php ENDPATH**/ ?>