...
<?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <section class="headerbg" style="background-image: url('<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($allsettings->site_header_background); ?>');">
      <div class="container text-left">
        <h2 class="mb-0"><?php echo e(Helper::translation(2912,$translate)); ?> <?php echo e(Helper::translation(2918,$translate)); ?> <?php echo e($user_details->username); ?></h2>
      ...
      <div>
         	    ...
         	    <div class="container emp-profile">
                  <div class="row">
                    <div class="col-md-3 white-bg">
                        ...
                        <i class="fa fa-check-circle green" aria-hidden="true"></i> <?php echo e(Helper::translation(2922,$translate)); ?>

                        <?php else: ?>
                        <i class="fa fa-times-circle-o red" aria-hidden="true"></i> <?php echo e(Helper::translation(2925,$translate)); ?>
                        ...
                        <a href="<?php echo e(url('/')); ?>/user/<?php echo e($user_details->username); ?>" title="<?php echo e($user_details->name); ?>" class="btn button-color btn-sm"><?php echo e(Helper::translation(1977,$translate)); ?></a>
                        </div>
                        </div>
                        </div>
                        
                        <div class="mt-5 mb-3">
                         <h4 class="mb-3"><?php echo e(Helper::translation(2154,$translate)); ?></h4>
		...
		<div class="comment-wrap">
				...
				<div class="comment-block">
                        ...
                        <?php echo csrf_field(); ?>
								<textarea name="conver_text" id="" cols="30" rows="3" placeholder="<?php echo e(Helper::translation(2928,$translate)); ?>" data-bvalidator="required"></textarea>
                                ...
                                <input type="hidden" name="conver_url" value="<?php echo e(url('/conversation-to-buyer')); ?>">
				...
				<div class="comment-block">
						...
						<div class="bottom-comment">
                                ...
                                <ul class="comment-actions">
										...
										<li class="reply"><a href="<?php echo e(url('/conversation')); ?>/<?php echo e(base64_encode($chat->conver_id)); ?>" onClick="return confirm('<?php echo e(Helper::translation(1968,$translate)); ?>');"><span class="icon-delete"></span> <?php echo e(Helper::translation(1967,$translate)); ?></a></li>
								</ul>
                                <?php endif; ?>
						</div>
				</div>
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\zigkart\resources\views/conversation-to-vendor.blade.php ENDPATH**/ ?>