                            ...
                            <div class="card-body">
                             ...
                             <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                                    ...
                                                                    <input type="file" id="category_image" name="category_image" class="form-control-file" data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg">
                                                                </div>
                                                <?php if($edit['category']->category_image != ''): ?>
                                                <img height="50" src="<?php echo e(url('/')); ?>/public/storage/category/<?php echo e($edit['category']->category_image); ?>"  /><?php else: ?> <img height="50" src="<?php echo e(url('/')); ?>/public/img/no-image.jpg"  />  <?php endif; ?>
...
<?php /**PATH D:\xampp\htdocs\zigkart\resources\views/admin/edit-category.blade.php ENDPATH**/ ?>