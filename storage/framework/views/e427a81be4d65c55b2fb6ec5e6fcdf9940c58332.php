         	    ...
         	    <div class="container emp-profile">
                  <div class="row">
                    <div class="col-md-3 white-bg">
                        ...
                        <a href="<?php echo e(url('/my-orders')); ?>" class="btn btn-danger btn-sm">&lt; <?php echo e(Helper::translation(2088,$translate)); ?></a>
		...
		<div class="comment-wrap">
				...
				<div class="comment-block">
                        ...
                        <?php echo csrf_field(); ?>
                                ...
                                <input type="hidden" name="conver_url" value="<?php echo e(url('/conversation-to-vendor')); ?>">
		...
		<div class="comment-wrap li-item">
				<div class="photo">
                       <?php 
                        ...
                        ?> 
						<div class="avatar" style="background-image: url('<?php echo e(url('/')); ?>/<?php echo e($paths); ?>')"></div>
				</div>
				<div class="comment-block">
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\zigkart\resources\views/conversation-to-buyer.blade.php ENDPATH**/ ?>