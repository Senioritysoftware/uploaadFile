<script src="<?php echo e(URL::to('resources/views/template/js/jquery.min.js')); ?>"></script>
<script src="<?php echo e(URL::to('resources/views/template/js/owl.carousel.min.js')); ?>"></script>
...
<!-- cookie --><?php /**PATH D:\laragon\www\script1\resources\views/javascript.blade.php ENDPATH**/ ?>