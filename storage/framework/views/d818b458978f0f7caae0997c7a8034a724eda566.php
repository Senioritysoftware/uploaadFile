	...
	<div class="container pt-3 pb-3">
		<section class="footer-top padding-top">
			<div class="row">
				...
				<aside class="col-sm-3  col-md-3">
					<h5 class="title text-secondary"><?php echo e(Helper::translation(2023,$translate)); ?></h5>
					<ul class="list-unstyled">
                        <?php if($allsettings->site_blog_display == 1): ?>
						<li> <a class="text-dark" href="<?php echo e(URL::to('/blog')); ?>"> <?php echo e(Helper::translation(1978,$translate)); ?> </a></li>
                        <?php endif; ?>
						<li> <a class="text-dark" href="<?php echo e(URL::to('/register')); ?>"> <?php echo e(Helper::translation(2024,$translate)); ?> </a></li>
						<li> <a class="text-dark" href="<?php echo e(URL::to('/my-profile')); ?>"> <?php echo e(Helper::translation(2025,$translate)); ?> </a></li>
						<li> <a class="text-dark" href="<?php echo e(URL::to('/my-orders')); ?>"> <?php echo e(Helper::translation(2026,$translate)); ?> </a></li>
						<li> <a class="text-dark" href="<?php echo e(URL::to('/wishlist')); ?>"> <?php echo e(Helper::translation(2027,$translate)); ?> </a></li>
					</ul>
				</aside>
				<aside class="col-sm-3  col-md-3">
					<h5 class="title text-secondary"><?php echo e(Helper::translation(2028,$translate)); ?></h5>
					<ul class="list-unstyled">
						...
						<li> <a class="text-dark" href="<?php echo e(URL::to('/page/')); ?>/<?php echo e($pages->page_slug); ?>"> <?php echo e($pages->page_title); ?> </a></li>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <li> <a class="text-dark" href="<?php echo e(URL::to('/contact')); ?>"> <?php echo e(Helper::translation(2012,$translate)); ?> </a></li>
					</ul>
				</aside>
                <?php if($allsettings->site_newsletter_display == 1): ?>
				<aside class="col-sm-3">
					<article>
						<h5 class="title text-secondary"><?php echo e(Helper::translation(2029,$translate)); ?></h5>
						<p class="pb-2 text-dark"><?php echo e($allsettings->site_subscribe_text); ?></p>
                        <div>
   ...
   <div class="container pt-4">
      <div class="row">
			<div class="col-lg-6 col-md-6 col-sm-12"> 
				<p class="text-black"><strong><?php echo $allsettings->site_copyright; ?> <?php echo e($allsettings->site_title); ?></strong></p>
			</div>
...
<?php endif; ?><?php /**PATH D:\laragon\www\script1\resources\views/footer.blade.php ENDPATH**/ ?>