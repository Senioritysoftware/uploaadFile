             ...
             <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <?php $__currentLoopData = $order['details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <a href="<?php echo e(url('/conversation-to-buyer')); ?>/<?php echo e($product->username); ?>/<?php echo e($encrypter->encrypt($product->ord_id)); ?>" class="btn btn-primary btn-sm">Start Conversation</a>
                                            <?php else: ?>
                                            <span>---</span>
                                            <?php endif; ?>
                                            </td>
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\zigkart\resources\views/my-orders.blade.php ENDPATH**/ ?>